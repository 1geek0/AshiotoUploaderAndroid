...
class RecyclerItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    interface OnItemClickListener {
         ...
         */
        void onItemClick(AppCompatTextView childView, int position);
     ...
     */
    static abstract class SimpleOnItemClickListener implements OnItemClickListener {
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent event) {
            if (childView != null) {
                listener.onItemClick((AppCompatTextView) childView, childViewPosition);
            }
